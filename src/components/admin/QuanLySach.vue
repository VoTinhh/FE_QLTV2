                            ...
                            <tbody>
                                <tr class="table-row-hover">
                                    ...
                                    <td class="text-center">
                                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/b8/9e/8b/4e76b82bb6ddd4f25e86c961f98d5ab9.png"
                                            alt="Book Image" class="img-fluid rounded shadow-sm"
                                            style="max-width: 80px; height: auto" />
                                    </td>
                                    <td>Vì cậu là bạn nhỏ của tớ</td>
                                    <td class="text-center">Tun Phạm</td>
                                    ...
                                    <td class="text-center">80.000 VNĐ</td>
                                    <td class="text-center">Kim Đồng</td>
                                    ...
                                    <td class="text-center">Khu A Kệ 7 Ngăn 44</td>
                                    <td class="text-center">
                        ...
                        <form>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" id="editImageInput" class="form-control" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="editAuthorInput" class="form-control" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="editPublisherInput" class="form-control" />
                                </div>
                                <div class="col-md-6">
                                    <label for="editQuantityInput" class="form-label">Số Lượng</label>
                                    <input type="number" id="editQuantityInput" class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="editDescriptionInput" class="form-label">Mô Tả Ngắn</label>
                                <textarea id="editDescriptionInput" class="form-control" rows="4"></textarea>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="editLocationInput" class="form-control" />
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-justify" style="line-height: 1.8">
                            ...
                            <p>
                                Nhờ vào góc nhìn và tâm tư sâu sắc, quyển sách như cẩm nang đồng
                                hành cùng thế hệ trẻ vượt qua cơn bão “overthinking” với những cảm
                                xúc, suy nghĩ tiêu cực trong các vấn đề khó khăn thường gặp.
                            </p>
                            <p>
                                GenZ có lẽ là một thế hệ luôn loay hoay, bối rối với câu hỏi:
                                <em>“Liệu mình là ai và mình cần làm gì khi đến với thế giới
                                    này?”</em>. Tác giả sẽ cùng bạn bước thật vững trong chặng đường thấu hiểu
                                thế giới nội tâm, đưa ra các giải pháp cho các vấn đề thường nhật
                                như:
                            </p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    Thực hành tư duy biết ơn để trân trọng thực tại và khởi đầu niềm
                                    hạnh phúc tự thân.
                                </li>
                                <li>
                                    Kiểm soát cơn lốc “overthinking” khiến người trẻ tổn hao tâm
                                    lực.
                                </li>
                                <li>
                                    Khám phá giá trị nội tại và bí kíp tự tạo cơ hội giúp bản thân
                                    “rực sáng”.
                                </li>
                                <li>
                            ...
                            <p>
                                Bạn sẽ không còn cô độc, vì đã có tác giả dìu dắt bạn vượt qua
                                những khoảng tối của hành trình trưởng thành, giúp bạn không còn
                                lạc lối và dần tìm thấy hướng đi mà bạn vốn có.
                            </p>
                            <p>
                                Mong bạn luôn nhớ rằng:
                                <strong>“Thật may mắn khi chúng ta gặp được nhau ở kiếp này. Vậy nên
                                    đừng vì những chuyện nhỏ nhặt mà rời đi nhé.”</strong>
                            </p>
                        </div>
                    </div>
                    <div class="modal-footer">
